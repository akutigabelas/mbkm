        ...
        <div class="col-lg-10">
            ...
            <?php if (session()->get('role') == 'Mahasiswa') : { ?>
                ...
                <ul class="nav nav-tabs">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="/pages/homeStupen2024">Peserta Studi Independen</a>
                    </li>
                    <li class="nav-item">
                ...
                <table class="table" id="example">
                    ...
                    <tbody>
                        ...
                        <?php
                        $sql = "SELECT * FROM stupen_mbkm WHERE created_at BETWEEN '2024-03-01' AND '2024-05-01'";
