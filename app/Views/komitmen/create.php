...
<div class="container">
    <div class="row">
        <div class="col-8">
            ...
            <form action="/komitmen/save" method="POST" enctype="multipart/form-data">
                <?= csrf_field(); ?>
                <div class="row mb-3">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        ...
                        <select class="form-control col-sm-2 mt-3 mb-3" name="fakultas" id="fakultas" required="" autofocus value="<?= old('fakultas'); ?>">
                            <option selected disabled hidden>Pilih</option>
                            <option value="Ekonimi dan Bisnis">Ekonomi dan Bismis</option>
                ...
                <div class="row mb-3">
                    <label for="surat_komitmen" class="col-sm-2 custom-form-label">surat_komitmen</label>
                    <div class="col-auto">
                ...
                <!-- <div class="row mb-3">
                    <label for="ss_mitra" class="col-sm-2 col-form-label">ss_mitra</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="ss_mitra" name="ss_mitra" autofocus value="<?= old('ss_mitra'); ?>">
                    </div>
                </div> -->
                <div class="row mb-3">
