...
<div class="container">
    <div class="row">
        <div class="col-8">
            ...
            <form action="/Komitmen/create3/<?= $surat_komitmen['id']; ?>" method="POST">
                <?= csrf_field(); ?>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="email" class="form-control" id="email" name="email" autofocus value="<?= (old('email')) ?
                                                                                                                old('email') : $surat_komitmen['email'] ?>" readonly>
                    </div>
                </div>
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control <?= ($validation->hasError('nama_mahasiswa')) ? 'is-invalid' : ''; ?>" id="nama_mahasiswa" name="nama_mahasiswa" autofocus value="<?= (old('nama_mahasiswa')) ?
                                                                                                                                                                                                        old('nama_mahasiswa') : $surat_komitmen['nama_mahasiswa'] ?>" readonly>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="npm_mahasiswa" name="npm_mahasiswa" autofocus value="<?= (old('npm_mahasiswa')) ?
                                                                                                                                old('npm_mahasiswa') : $surat_komitmen['npm_mahasiswa'] ?>" readonly>
                    </div>
                </div>
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="program_studi" name="program_studi" autofocus value="<?= (old('program_studi')) ?
                                                                                                                                old('program_studi') : $surat_komitmen['program_studi'] ?>" readonly>
                    </div>
                </div>
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="fakultas" name="fakultas" autofocus value="<?= (old('fakultas')) ?
                                                                                                                    old('fakultas') : $surat_komitmen['fakultas'] ?>" readonly>
                    </div>
                </div>
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="semester" name="semester" autofocus value="<?= (old('semester')) ?
                                                                                                                    old('semester') : $surat_komitmen['semester'] ?>" readonly>
                    </div>
                </div>
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="ipk" name="ipk" autofocus value="<?= (old('ipk')) ?
                                                                                                            old('ipk') : $surat_komitmen['ipk'] ?>" readonly>
                    </div>
                </div>
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="jumlah_sks" name="jumlah_sks" autofocus value="<?= (old('jumlah_sks')) ?
                                                                                                                        old('jumlah_sks') : $surat_komitmen['jumlah_sks'] ?>" readonly>
                    </div>
                </div>
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="no_wa" name="no_wa" autofocus value="<?= (old('no_wa')) ?
                                                                                                                old('no_wa') : $surat_komitmen['no_wa'] ?>" readonly>
                    </div>
                </div>
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="bentuk_kegiatan" name="bentuk_kegiatan" autofocus value="<?= (old('bentuk_kegiatan')) ?
                                                                                                                                    old('bentuk_kegiatan') : $surat_komitmen['bentuk_kegiatan'] ?>" readonly>
                    </div>
                </div>
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="mitra_perusahaan" name="mitra_perusahaan" autofocus value="<?= (old('mitra_perusahaan')) ?
                                                                                                                                    old('mitra_perusahaan') : $surat_komitmen['mitra_perusahaan'] ?>" readonly>
                    </div>
                </div>
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="learning_path" name="learning_path" autofocus value="<?= (old('learning_path')) ?
                                                                                                                                old('learning_path') : $surat_komitmen['learning_path'] ?>" readonly>
                        <a href="<?= site_url('gambar/' . $surat_komitmen['learning_path']); ?>"> show it </a>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="surat_komitmen" name="surat_komitmen" autofocus value="<?= (old('surat_komitmen')) ?
                                                                                                                                old('surat_komitmen') : $surat_komitmen['surat_komitmen'] ?>" readonly>
                        <a href="<?= site_url('gambar/' . $surat_komitmen['ss_mitra']); ?>"> show it </a>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="foto" name="foto" autofocus value="<?= (old('foto')) ?
                                                                                                                old('foto') : $surat_komitmen['foto'] ?>" readonly>
                            <a href="<?= site_url('gambar/' . $surat_komitmen['foto']); ?>"> show it </a>
                        </div>
                    </div>
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            ...
                            <?php if (in_groups(['warek-admin'])) : ?>
                                <input type="text" class="form-control" id="ket_status2" name="ket_status2" autofocus value="<?= (old('ket_status2')) ?
                                                                                                                                    old('ket_staus2') : $surat_komitmen['ket_status2'] ?>" readonly>
                            <?php endif; ?>
                        </div>
                    </div>
                    <button type="submit" class="btn btn-primary mt-3 mb-3">submit</button>
                    <!-- <a href="/komitmen" class="btn btn-primary mt-3 mb-3">submit</a> -->
