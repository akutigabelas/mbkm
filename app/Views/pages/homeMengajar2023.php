        ...
        <div class="col-lg-10">
            ...
            <?php if (session()->get('role') == 'Mahasiswa') : { ?>
                ...
                <ul class="nav nav-tabs">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="/pages/homeStupen2023">Peserta Studi Independen</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active" href="/pages/homeMengajar2023">Peserta Kampus Mengajar</a>
                    </li>
                </ul>
                ...
                <table class="table" id="example">
                    ...
                    <tbody>
                        ...
                        <?php
                        $sql = "SELECT * FROM mengajar_mbkm WHERE created_at BETWEEN '2023-03-01' AND '2023-05-01'";
                ...
                <div class="row">
                    ...
                    <?php if (in_groups('dosen')) : ?>
                        <ul class="nav nav-tabs">
                            <li class="nav-item">
                                <a class="nav-link active" href="/pages/homeMhs">Peserta Magang</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="/pages/homeStupen2023">Peserta Studi Independen</a>
                            </li>
