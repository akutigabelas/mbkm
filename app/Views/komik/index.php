...
<div class="container">
        ...
        <div class="col">
            ...
            <div class="card-body">
                <ul class="nav nav-tabs">
                    <li class="nav-item">
                        <a class="nav-link active" style="color: black;" href="komik">Daftar Mahasiswa</a>
                    </li>
                </ul>
            </div>
            <?php
            ...
            if (session()->get('role') == 'Mahasiswa') : { ?>
                    ...
                    <a href="/Komik/create" class="btn btn-primary mt-3">Daftar Data Mahasiswa</a> <br>
                    <a href="https://docs.google.com/document/d/1iaNR2sPVBCclK1dfnCywBEazBcpSCItb0qaDpZHZNFE">Download Surat Komitmen</a> <br>
                    <a href="https://docs.google.com/document/d/1FPPLqaqUKJsmbIDyh3KZvd8uJaHc5kMJYHr1vO-YfRA/edit?usp=sharing">Download Surat Persetujuan Prodi</a>
            <?php }
            endif; ?>
            ...
            <table class="table" id="example">
                <form action="/komik/kegiatan" method="POST" enctype="multipart/form-data">
                    <thead>
                        <tr>
                            <th scope="col">No.</th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php if (session()->get('role') == 'Dosen') : { ?> <?php
                                                                                            if ($a['status'] == "") {
                                                                                            ?>
                                                    <a href="/komik/lanjut/<?= $a['nama_mahasiswa']; ?>" class="btn btn-primary">Verifikasi</a>
                                                <?php  } elseif ($a['status'] != "") { ?>
                    ...
                    ?>
                            <tbody>
                                ...
                                $sqll = 'SELECT * FROM magang_mbkm WHERE npm_mahasiswa LIKE ' . $npm;
                                // print_r($sqll);
                                // die;
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php if (session()->get('role') == 'Mahasiswa') : { ?> <?php
                                                        ...
                                                        <a href="/komik/generate/<?= $row['nama_mahasiswa']; ?>" class="btn btn-primary">Download</a>
                        ...
                        <?php }
                            ...
                            <tbody>
                                ...
                                <?php if (in_groups(['dosen-hukum'])) : { ?>
                                        <?php //$npm = session()->get('id_nik');
                                        $sqll = 'SELECT * FROM magang_mbkm WHERE npm_mahasiswa LIKE "130%"';
                                        $resultt = mysqli_query($con, $sqll);
                                        $angka = 0;
                                        // print_r($sqll);
                                        // die;
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php if (in_groups(['dosen-hukum'])) : { ?>
                                                            <?php if ($row['status'] == "") {
                                                            ?>
                                                                <a href="/komik/lanjut/<?= $row['nama_mahasiswa']; ?>" class="btn btn-primary">Verifikasi</a>
                    ...
                    <tbody>
                        ...
                        <?php if (in_groups(['dosen-eko'])) : { ?>
                                <?php //$npm = session()->get('id_nik');
                                $sqll = 'SELECT * FROM magang_mbkm WHERE npm_mahasiswa LIKE "120%"';
                                $resultt = mysqli_query($con, $sqll);
                                $angka = 0;
                                // print_r($sqll);
                                // die;
            ...
            <tbody>
                ...
                <?php if (in_groups(['dosen-akt'])) : { ?>
                        <?php //$npm = session()->get('id_nik');
                        $sqll = 'SELECT * FROM magang_mbkm WHERE npm_mahasiswa LIKE "121%"';
                        $resultt = mysqli_query($con, $sqll);
                        $angka = 0;
                        // print_r($sqll);
                        // die;
    ...
    <tbody>
        ...
        <?php if (in_groups(['dosen-ti'])) : { ?>
                <?php //$npm = session()->get('id_nik');
                $sqll = 'SELECT * FROM magang_mbkm WHERE npm_mahasiswa LIKE "140%"';
                $resultt = mysqli_query($con, $sqll);
                $angka = 0;
                // print_r($sqll);
                // die;
...
<tbody>
    ...
    <?php if (in_groups(['dosen-pdsi'])) : { ?>
            <?php //$npm = session()->get('id_nik');
            $sqll = 'SELECT * FROM magang_mbkm WHERE npm_mahasiswa LIKE "150%"';
            $resultt = mysqli_query($con, $sqll);
            $angka = 0;
            // print_r($sqll);
            // die;
...
<tbody>
    ...
    <?php if (in_groups(['dosen-psi'])) : { ?>
            <?php //$npm = session()->get('id_nik');
            $sqll = 'SELECT * FROM magang_mbkm WHERE npm_mahasiswa LIKE "160%"';
            $resultt = mysqli_query($con, $sqll);
            $angka = 0;
            // print_r($sqll);
            // die;
            ...
            <tr>
                ...
                <td>
                    <?php if (in_groups(['warek',  'warek-admin'])) : { ?> <?php
                                                                            if ($a['status2'] == "") {
                                                                            ?>
                                <a href="/komik/lanjut2/<?= $a['nama_mahasiswa']; ?>" class="btn btn-primary">Verifikasi</a>
