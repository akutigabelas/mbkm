...
class AuthLdap
{
    ...
    private function _authenticate($userName, $password): array
    {
        ...
        if (
            !is_resource($ldapSearchResource)
        ...
        // $street = $ldapEntries[0]['street'][0];
        // $homephone = $ldapEntries[0]['homephone'][0];
        // $homepostaladdress = $ldapEntries[0]['homepostaladdress'][0];
        // $telephonenumber = $ldapEntries[0]['telephonenumber'][0];
