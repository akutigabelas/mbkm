...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-lg-10">
            <h2 class="my-3">Daftar Peserta Kampus Mengajar Tahun <?= date('Y')  ?></h2>
            ...
            <?php if (session()->get('role') == 'Mahasiswa') : { ?>
                ...
                <ul class="nav nav-tabs">
                    <li class="nav-item">
                        <a class="nav-link" href="/pages/home2024">Peserta Magang</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="/pages/homeStupen2024">Peserta Studi Independen</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active" href="/pages/homeMengajar2024">Peserta Kampus Mengajar</a>
                    </li>
                </ul>
                ...
                <table class="table" id="example">
                    ...
                    <tbody>
                        ...
                        <?php
                        $sql = "SELECT * FROM mengajar_mbkm WHERE created_at BETWEEN '2024-03-01' AND '2024-05-01'";
