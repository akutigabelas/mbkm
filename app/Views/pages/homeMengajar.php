        ...
        <div class="col-lg-10">
            ...
            <?php if (session()->get('role') == 'Mahasiswa') : { ?>
                ...
                <ul class="nav nav-tabs">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="/pages/homeMengajar">Peserta Kampus Mengajar</a>
                    </li>
                </ul>
                ...
                <table class="table text-center" id="example">
                    ...
                    <tbody>
                        ...
                        <?php
                        $sql = "SELECT * FROM mengajar_mbkm WHERE created_at BETWEEN '2022-03-01' AND '2022-05-01'";
                        // $sql = "SELECT * FROM mengajar_mbkm WHERE npm_mahasiswa LIKE '140%' AND created_at BETWEEN '2022-03-01' AND '2022-05-01'";
