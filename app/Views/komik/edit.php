...
<div class="container">
    <div class="row">
        <div class="col-8">
            <h2 class="my-3">Form Data Mahasiswa</h2>
            <form action="/Komik/update/<?= $surat_rekomendasi['id']; ?>" method="POST">
                <?= csrf_field(); ?>
                ...
                <div class="row mb-3">
                    <label for="learning_path" class="col-sm-2 col-form-label">Learning Path</label>
                    <div class="col-sm-10">
                ...
                <div class="row mb-3">
                    <?php if (session()->get('role') == 'Dosen') : { ?>
                            ...
                            <select class="form-control col-sm-2 col-form-label mt-3 mb-3" name="status" id="status" required="">
